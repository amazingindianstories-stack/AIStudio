...
| ARCH-01 | API responses use multiple envelopes | P2 | in_progress | 2026-09-04 | Codex | Phase 1 introduces canonical helpers plus a legacy-compatible client parser and migrates only the authentication route family. Keep open until every route family is migrated. |
