...
| REL-01 | Dead depth worker strands a running job | P1 | in_progress | 2026-08-26 | Codex | Local `4301601` implements claim-fenced bounded recovery; PostgreSQL tests pass and unsafe `fb7046b` was not reused. Exit: migrate/deploy, update the worker, and complete VER-04's real deliberate-kill exercise. |
...
- 2026-08-26: implemented REL-01 locally with per-claim fencing, claim-scoped output
