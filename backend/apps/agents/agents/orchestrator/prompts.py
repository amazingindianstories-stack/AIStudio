"""Port of src/lib/agents/orchestrator/prompts.js."""

SHARED = """You are the chat assistant inside Lumina Studio's %KIND% tab, an AI %KIND%
...
PROMPTS = {"image": SHARED.replace("%KIND%", "image"), "video": SHARED.replace("%KIND%", "video")}
