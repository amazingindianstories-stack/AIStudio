...
urlpatterns = [
    ...
    path("agents/image", agent_views.agent_image, name="agent-image"),
    path("agents/video", agent_views.agent_video, name="agent-video"),
    path("agents/story", agent_views.agent_story, name="agent-story"),
]
