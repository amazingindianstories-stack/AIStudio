...
export const MODEL_REGISTRY = [
  {
    ...
    offered: true,
    badge: "MULTI-REF",
    hint: "Create or revise images with multiple references — supports 1K, 2K and 4K",
  ...
  },
  {
    ...
    offered: true,
    badge: "NEW",
    hint: "Image creation with one reference — 1K or 2K",
  ...
  },
  {
    ...
    offered: true,
    badge: "SINGLE REF",
    hint: "Image creation with one reference — 1K with a reference; up to 2K without one",
  ...
  },
  {
    ...
    offered: true,
    badge: "UP TO 9 REFS",
    hint: "Video with up to 9 reference images. Photorealistic faces are rejected by this model.",
  ...
  },
  {
    ...
    offered: true,
    badge: "NEW",
    hint: "Create video, edit a clip or extend it — up to 30 seconds; see settings for available sizes",
  ...
  },
  {
    ...
    offered: true,
    badge: "NEW",
    hint: "Video guided by image references — landscape 16:9 or portrait 9:16",
