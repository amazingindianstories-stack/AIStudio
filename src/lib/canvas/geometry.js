...
export function boundsContain(outer, innerCenter) {
  return (
...
function anchorPoint(bounds, anchor, towards) {
...
export function hitTest(state, worldPoint) {
...
export function marqueeHits(state, worldRect) {
  const hits = [];
