...
function h(past, present, future) {
...
test("commit: bounded depth — past never exceeds the documented cap of 50, dropping the oldest entries first", () => {
  ...
  const start = h(past, "present-before", []);
