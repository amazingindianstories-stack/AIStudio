...
test("local composer restoration validates render controls against the provider", () => {
...
test("cloneToComposer restores stored settings and gives legacy rows the new defaults", async () => {
