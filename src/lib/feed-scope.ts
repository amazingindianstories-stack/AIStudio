...
export type FeedTab = "project" | "history" | "favorites";
...
export interface FeedScope {
  ...
  /** null = any folder ("All in project"); UNSORTED = in no folder. */
...
export function scopeToQuery(scope: FeedScope): {
  projectId?: string;
  folderId?: string | null;
  kind?: "all" | GenerationKind;
  favorite?: boolean;
 ...
 */
export function matchesScope(item: GenerationItem, scope: FeedScope): boolean {
 ...
 */
export function sortValue(item: GenerationItem, scope: FeedScope): number {
