...
import type { AssembledGroup, AssembledPrompt } from "./prompt-assembler";
...
function group(over: Partial<AssembledGroup> = {}): AssembledGroup {
  return { tag: "@img1", header: "@img1 — REFERENCE:", images: [img()], ...over };
}

function assembled(over: Partial<AssembledPrompt> = {}): AssembledPrompt {
