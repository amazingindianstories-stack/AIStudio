 ...
 * old behaviour.
 */
export const THUMB_LADDER = [512, 1280] as const;
 ...
 */
export function thumbLadderWidth(width: number): number | null {
...
export function originalKeyFromThumb(key: string): { key: string; width: number } | null {
