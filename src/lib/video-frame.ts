...
export interface VideoFrameResult {
  dataUrl: string;
  /** Where in the clip the frame came from, in seconds. */
  time: number;
  duration: number;
  width: number;
  height: number;
 ...
 */
export async function loadVideo(src: string | Blob): Promise<{
...
export function drawFrame(video: HTMLVideoElement): string {
