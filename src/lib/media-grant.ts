...
export function signMediaGrant(key: string, ttlSeconds = DEFAULT_TTL_SECONDS): string {
...
export function verifyMediaGrant(token: string | null | undefined): string | null {
...
export function mediaGrantUrl(key: string, ttlSeconds?: number): string {
