import type { Agent, AgentRequest, AgentResponse, AgentRole } from "./types";
...
function withContext(systemPrompt: string, context?: Record<string, unknown>): string {
...
export function createChatAgent(role: AgentRole): Agent {
  return {
